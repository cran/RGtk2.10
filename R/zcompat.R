# wrappers for RGtk1 functions to RGtk2.10
...
function(w, row, cols, zeroBased = TRUE)
{
  ...
  .Call("R_gtkCListGetText", w, as.integer(t(which)), PACKAGE = "RGtk2.10")
}
...
function(w, row, cols, values, zeroBased = TRUE)
{
  ...
  invisible(.Call("R_gtkCListSetText", w, which, values, PACKAGE = "RGtk2.10"))
}
