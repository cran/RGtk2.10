...
function(object, parent, position, columns, values)
{
  ...
  w <- .RGtkCall("S_gtk_tree_store_insert_with_valuesv", object, parent, position, columns, values, PACKAGE = "RGtk2.10")
...
function(object, attach.widget)
{
        ...
        w <- .RGtkCall("S_gtk_menu_attach_to_widget", object, attach.widget, PACKAGE = "RGtk2.10")
...
function(object, ...)
{
	...
	w <- .RGtkCall("S_gtk_widget_destroy", object, PACKAGE = "RGtk2.10")
