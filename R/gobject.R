...
{
  type <- as.GType(type)
  .Call("R_getGTypeAncestors", type, PACKAGE = "RGtk2.10")
}
...
{
  type <- as.GType(type)
  .Call("R_getInterfaces", type, PACKAGE = "RGtk2.10")
}
...
function(type)
{
  ...
  class_ptr <- .Call("R_getGTypeClass", type, PACKAGE = "RGtk2.10")
...
function(name)
{
 .Call("R_gTypeFromName", as.character(name), PACKAGE = "RGtk2.10")
}
...
function(obj, signal, f, data = NULL, after = FALSE, user.data.first = FALSE)
{
  ...
  .Call("R_connectGSignalHandler", obj, f, as.character(signal), data, useData, 
    as.logical(after), as.logical(user.data.first), PACKAGE = "RGtk2.10")
}
...
{
 checkPtrType(obj, "GObject")
 .Call("R_disconnectGSignalHandler", obj, as.integer(id), PACKAGE = "RGtk2.10")
}
...
{
  checkPtrType(obj, "GObject")
 .Call("R_blockGSignalHandler", obj, as.integer(id), TRUE, PACKAGE = "RGtk2.10")
}
...
{
  checkPtrType(obj, "GObject")
 .Call("R_blockGSignalHandler", obj, as.integer(id), FALSE, PACKAGE = "RGtk2.10")
}
...
function(obj, signal, detail = NULL)
{
  ...
  .Call("R_gSignalStopEmission", obj, signal, PACKAGE = "RGtk2.10")
}
...
function(type)
{
  ...
  els <- .Call("R_getGSignalIdsByType", type, PACKAGE = "RGtk2.10")
...
function(sig)
{
 ...
 .Call("R_getGSignalInfo", sig, PACKAGE = "RGtk2.10")
}
...
function(obj, signal, ..., detail = NULL)
{
  ...
  if (!is.null(detail))
    signal <- paste(signal, detail, sep="::")
  .RGtkCall("R_gSignalEmit", obj, signal, args, PACKAGE = "RGtk2.10")
}
...
{
   checkPtrType(obj, "GObject")
   props <- .Call("R_getGObjectProps", obj, as.character(c(...)), PACKAGE = "RGtk2.10")
...
function(obj, ...)
{
  ...
  invisible(.RGtkCall("R_setGObjectProps", obj, args, PACKAGE = "RGtk2.10"))
}
...
function(obj, propNames, value)
{
  ...
  .RGtkCall("R_setGObjectProps", obj, value, PACKAGE = "RGtk2.10")
  obj
}
...
function(type, ...)
{
  ...
  invisible(.RGtkCall("R_gObjectNew", type, args, PACKAGE = "RGtk2.10"))
}
...
function(obj, key, data = NULL)
{
        ...
        w <- .RGtkCall("S_g_object_set_data", obj, key, data, PACKAGE = "RGtk2.10")
...
function(obj, key)
{
        ...
        w <- .RGtkCall("S_g_object_get_data", obj, key, PACKAGE = "RGtk2.10")
...
function(method, obj = NULL, ...)
{
  ...
  parent <- .Call("S_g_object_parent", obj, PACKAGE = "RGtk2.10")
...
function(c_closure)
{
  ...
  closure <- function(...) {
    .RGtkCall("R_g_closure_invoke", c_closure, c(...), PACKAGE = "RGtk2.10")
  }
